...
fun sortedSquaredArray(array: List<Int>): List<Int> {
    ...
    // use starting and ending pointer based on array index. move pointer based of whether start or end abs value is
    // larger. stop when output array is full. we need a reverse order loop. O(N) time and space
